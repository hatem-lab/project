                        ...
                        <div class="box-content block_content">
                            <div id="verticalmenu" class="verticalmenu" role="navigation">
                                <ul class="menu level1">
                                    ...
                                    <li class="item  parent group" ><a href="#" title={{ $maincategory->name }}><i class="hasicon nov-icon" style="background:url('http://demo.bestprestashoptheme.com/savemart/themes/vinova_savemart/assets/img/modules/novverticalmenu/icon/Electronic.png') no-repeat scroll center center;"></i>  {{ $maincategory->name }}</a><span class="show-sub fa-active-sub"></span><span class="menu-sub-title">Blender , iron, Vacuum cleaner ...</span>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-lg-3 col-12">
                                                                ...
                                                                <ul>
                                                                    ...
                                                                    @if($subcategory->translation_lang==App::getLocale())
                                                                    @if($subcategory->parent_id==0)
                                                                    <p class="title-category">{{ $subcategory->name }}</p>
                                                                    @endif
                                                                    <ul>
                                                                    @foreach ($subcategory ->subcategorychildren as $subcategorychildren1)
                                                                    @if($subcategorychildren1->translation_lang==App::getLocale())
                                                                    <li style="color: blue" ><a>{{$subcategorychildren1->name}}</a> </li>
                                                                    @endif
                                                                    @endforeach
                                                                    </ul>
